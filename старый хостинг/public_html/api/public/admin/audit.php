...
<div class="card">
  ...
  <form method="get" style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:10px;margin:12px 0 14px;">
    ...
    <div style="display:flex;align-items:end;gap:8px;">
      ...
      <a href="/api/public/admin/audit.php" class="secondary" style="display:inline-block;padding:10px 12px;border:1px solid #d1d5db;border-radius:8px;text-decoration:none;">Сбросить</a>
    </div>
  </form>
  <table>
    <thead>
