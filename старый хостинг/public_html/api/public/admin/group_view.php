...
<div class="card">
  <p><a href="/api/public/admin/groups.php" class="btn btnGhost">← К списку групп</a></p>
  ...
  <p><a class="btn btnAccent" href="/api/public/admin/groups.php?edit=<?= (int)$group['id'] ?>">Редактировать группу</a></p>
</div>
      ...
      <table>
        ...
        <?php foreach ($students as $st): ?>
          <tr>
            ...
            <td><a href="/api/public/admin/student_view.php?id=<?= (int)$st['id'] ?>">Открыть</a></td>
          </tr>
        <?php endforeach; ?>
        </tbody>
      </table>
