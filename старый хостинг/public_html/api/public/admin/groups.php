...
<div class="card">
  ...
  <form method="post">
    ...
    <?php if ($editItem): ?>
      <a class="btn btnGhost" href="/api/public/admin/groups.php">Отмена</a>
      <a class="btn btnAccent" href="/api/public/admin/group_view.php?id=<?= (int)$editItem['id'] ?>">Открыть карточку</a>
    <?php endif; ?>
  </form>
</div>
      ...
      <?php foreach ($rows as $row): ?>
        <tr>
          ...
          <td style="white-space:nowrap;">
            <a href="/api/public/admin/group_view.php?id=<?= (int)$row['id'] ?>">Карточка</a>
            <span class="muted"> · </span>
            <a href="/api/public/admin/groups.php?edit=<?= (int)$row['id'] ?>">Редактировать</a>
            <?php if ($canDelete): ?>
