...
<div class="card">
  ...
  <ul>
    <li>Страниц для абитуриентов: <strong><?= $pagesCount ?></strong> (<a href="/api/public/admin/pages.php">редактировать</a>)</li>
    <li>Специальностей: <strong><?= $specialtiesCount ?></strong> (<a href="/api/public/admin/specialties.php">редактировать</a>)</li>
    <li>Партнеров: <strong><?= $partnersCount ?></strong> (<a href="/api/public/admin/partners.php">редактировать</a>)</li>
  </ul>
</div>
