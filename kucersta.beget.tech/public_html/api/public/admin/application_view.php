...
<div class="card">
  <p><a href="/api/public/admin/applications.php" class="btn btnGhost">← К списку заявок</a></p>
  <h2>Заявка #<?= $id ?></h2>
  ...
  <?php if (!empty($app['accepted_user_id'])): ?>
    <p class="muted">Связанный аккаунт студента: user_id <?= (int)$app['accepted_user_id'] ?> — <a href="/api/public/admin/student_view.php?id=<?= (int)$app['accepted_user_id'] ?>">Профиль</a></p>
  <?php endif; ?>
</div>
