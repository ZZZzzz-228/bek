...
<div class="card">
  ...
  <form method="get" class="filters">
    ...
    <div class="field">
      <label>&nbsp;</label>
      <a class="btn btnGhost" href="/api/public/admin/applications.php">Сбросить</a>
    </div>
    <div class="field">
      <label>&nbsp;</label>
      <a class="btn btnAccent" href="/api/public/admin/applications_export.php?<?= h($exportQs) ?>">Экспорт в CSV</a>
    </div>
  </form>
    ...
    <div class="tableWrap">
      <table>
        ...
        <?php foreach ($rows as $row): ?>
          <tr class="clickRow" data-href="/api/public/admin/application_view.php?id=<?= (int)$row['id'] ?>">
