...
<div class="card">
  ...
  <a class="btn btnAccent" href="/api/public/admin/users.php">Управление пользователями</a>
</div>
...
<div class="card">
  ...
  <?php endif; ?>
  <p class="muted" style="margin-top:12px;">Полный журнал действий: <a href="/api/public/admin/audit.php">Аудит</a> · <a href="/api/public/admin/backup.php">Бэкап БД</a></p>
</div>
