...
<div class="card">
  ...
  <form method="post">
    ...
    <?php if ($editItem): ?>
      <a class="btn btnGhost" href="/api/public/admin/disciplines.php">Отмена</a>
    <?php endif; ?>
  </form>
</div>
...
<div class="card">
  ...
  <form method="get" class="filters" style="margin-bottom:12px;">
    ...
    <?php if ($q !== ''): ?>
      <div class="field">
        <label>&nbsp;</label>
        <a class="btn btnGhost" href="/api/public/admin/disciplines.php">Сбросить</a>
      </div>
    <?php endif; ?>
  </form>
  <div class="tableWrap">
      ...
      <?php foreach ($rows as $row): ?>
        <tr>
          ...
          <td style="white-space:nowrap;">
            <a href="/api/public/admin/disciplines.php?edit=<?= (int)$row['id'] ?>">Редактировать</a>
            <?php if ($canDelete): ?>
